...
<body>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Thêm l</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="row">
		...
		<form:form action="save-categories" method="POST"
			modelAttribute="categoriesForm" class="col-md-10 card m-auto">
			...
			<div
				...
				<div class="control-group col-md-4">
					<label class="control-label"il">loại xe</label>
					<div class="controls">
						<form:input class="col-md-10 form-control" type="text" value=""
							required="required" placeholder="nhập loại xe" path="name" />
					</div>
				</div>
			...
			<div
				...
				<div class="control-group col-md-12">
					<label class="control-label" for="inputTitle">mô tả</label>
					<div class="controls">
						<form:input class="col-md-11 form-control" type="text"
							placeholder="Nhập mô tả " path="description" />
					</div>
				</div>
			...
			<div
				...
				<button type="submit" style="margin-left: 15px"
					class=" btn btn-success">Chấp nhận</button>
